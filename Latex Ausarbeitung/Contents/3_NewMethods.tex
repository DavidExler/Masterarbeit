...
Zur Wahl des Segmentierungsnetzes wird ein neues Bewertungskriterien eingeführt. 
...
\times
\underbrace{
\frac{k_3\times\displaystyle |P|}{\displaystyle\sum_{p \in P} \left( \max(1, n_p - 1) \right)} }_{\text{Injektivitäts-Qualität (IQ)}},
\end{equation}
wobei:
\begin{itemize}
