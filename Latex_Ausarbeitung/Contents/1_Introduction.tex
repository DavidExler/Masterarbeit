...
Um die Analyse der Myotuben effizient und in großem Umfang durchführen zu können, sind Bildverarbeitungsprogramme notwendig \cite{Noe2022}, da die manuelle Auswertung sowohl anspruchsvoll als auch zeitintensiv ist \cite{Weisrock2024}.
...
\begin{itemize}
    ...
    \item Das Klassifizieren der Zellkerne unter Einbezug der zur Verfügung stehenden Marker-Kanälen.
...
Die Methodik beschreibt das neue, praktische Konzept, das die Arbeit einführt und das Implementierungs-Kapitel, wie diese Methoden umgesetzt werden.
Im Kapitel Ergebnisse werden ungewertet die Ergebnisse der durchgeführten Experimente dargestellt, in der Diskussion werden dann diese Ergebnisse ausgewertet.
