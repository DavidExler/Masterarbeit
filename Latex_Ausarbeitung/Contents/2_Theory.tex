...
Ein besonders prominentes Exemplar ist das \ac{sam} \cite{kirillov2023sam} von Meta AI. 
...
Aus diesen Repräsentation generiert dann der trainierte Decoder mehrere mögliche Masken mit zugehörigen Score, anhand dessen ein finales Segmentierungsergebnis ausgewählt wird.
...
Zur Mekrmalsextraktion werden klassisch Metriken zu einem Vektor kombiniert \cite{Guyon2006}.
Diese Metriken können beispielsweise die Verteilung der Farbkanäle, eine Charakterisierung der Textur, Parameter der Fourier-Entwicklung einer Kontur, die Fläche des Objekts und vieles mehr sein \cite{Mutlag2020}.
