...
Viele etablierte Encoder sind \acp{cnn} oder \acp{vit}, die auf dem ImageNet Datensatz vortrainiert werden.
...
Es wurde gezeigt, dass residual connections dem Degradierungsproblem von Netzen mit steigender Tiefe entgegenwirken.
\begin{figure}
    \includegraphics[width=\linewidth]{Figures/ResidualConns.png}
...
Jedes Variante enthält fünf Blöcke mit residual connections.
Die Blöcke bestehen aus Faltungen mit verschiedenen Kernelgrößen und Strides, und der ReLU Aktivierungsfunktion.\newline
EfficientNetV2 ist der Nachfolger von effnet 1 Tan2019
