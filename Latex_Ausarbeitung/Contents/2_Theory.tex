...
\end{figure}
Für die verschiedenen Segmentierungsarten werden an die Aufgabe angepasste Architekturen verwendet \cite{Arnab2017, Chen2018}, dabei sind die Modelle in der Regel nach dem Vorbild des \textit{U-Net} \cite{Ronneberger2015} aus einem Merkmalsextraktor (Encoder) und einem Vorhersagenetz (Decoder) aufgebaut \cite{Girshick2014}.
Der Encoder nutzt dabei beispielsweise Bildfaltungen mit Kernen, deren optimale Gewichte anhand von annotierten Daten gelernt werden \cite{Long2015}.
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{Figures/SWINV2_Architecture.png}
    \caption{}
