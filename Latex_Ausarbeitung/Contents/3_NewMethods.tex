...
Die Methodik wird in einer Anwendung umgesetzt die 3D-Daten als Eingabe annimmt und interpretierbare Eigenschaften wie die Verteilung der Klassen und Volumen der anwesenden Nuclei ausgibt.
...
\begin{figure}[h]
  ...
  Die Anwendung kann regulär angewandt (Inferenz) oder optimiert werden (Optimierung).
  Bei der Inferenz werden 3D-Daten von der Anwendung als Eingabe angenommmen und interpretierbare Eigenschaften wie die Verteilung der Klassen und Volumen der anwesenden Nuclei werden ausgegeben.
  Zur Optimierung werden die 3D-Daten in den Ablauf für den Vergleich der Segmentierungsmodelle oder der Klassifikatormethoden eingegeben.
  ...
  Mithilfe der \ac{ipq}-Werte wird ein optimales Segmentierungsmodell gewählt.
  Die Architektur und die Parameter des optimalen Model werden in den Ablauf der Anwendung eingesetzt.
