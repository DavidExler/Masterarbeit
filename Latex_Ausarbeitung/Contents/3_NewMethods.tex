...
Da die Klassifikatoren Eingaben konstanter Größe benötigen werden, werden für jeden Klassifikator zusätzlich drei verschiedene Eingangsdaten-Formate getestet.
...
Daten des ersten Typs werden lediglich um einen Kanal erweitert, der die Segmentierungsmaske enthält.
Für den zweiten Typ wird der minimale Begrenzungsrahmen des segmentierten Nucleus aus dem originalen Nucleus Kanal ausgeschnitten. 
Alle anderen Kanäle bleiben unverändert.
