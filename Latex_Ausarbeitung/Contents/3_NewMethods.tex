...
\begin{figure}[h]
  ...
  Anschließend wird mit Experten-Labels der Klassifikations-Kopf neu trainiert.
...
Diese neuen Annotationen werden dann eingesetzt, um in 25 Epochen sowohl die Encoder, als auch die Klassifikations-Köpfe zu trainieren, mit dem Ziel unter geringem Aufwand für die Experten umfangreiche Klassifikatoren zu trainieren.
