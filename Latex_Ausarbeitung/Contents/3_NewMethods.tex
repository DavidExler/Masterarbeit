...
Um die Klassifikatormethoden zu optimieren werden die Daten und die Segmente in die neu entwickelte Labeling-App eingegeben.
...
Alle Experimente auf diesen Daten dienen der vorliegenden Arbeit als Fallstudie, um die Effizient der vorgestellten Methoden zu demonstrieren.
...
Darüber hinaus werden hier verschiedene Methoden der Vorverarbeitung, des Vortraining und der Klassifikations-Kopf-Architektur eingeführt und verglichen.
...
Um einen Einfluss auf die Ergebnisse durch ungleiche Verteilung der Annotationen auf die vorhandenen Klassen zu vermeiden, extrahiert der Retreiver außerdem vor dem Training, bei der Initialisierung, die Anzahl der Stichproben pro Klasse.
...
In 50 Epochen wwerden dann die verbleibenden Encoder-Schichten und der Klassifikations-Kopf trainiert.
...
Hier werden dazu zwei neue Klassifikations-Kopf-Architekturen nach dem Vorbild vergleichbarer Anwendungen in der Literatur eingeführt.
