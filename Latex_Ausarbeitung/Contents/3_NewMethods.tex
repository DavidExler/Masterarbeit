...
\end{equation}
wobei $N$ die Anzahl der Vorhersagen, $\hat{y}_i$ die Vorhersage des Klasifikators und $y_i$ die \ac{gt} ist. (\textit{Notiz: Ist das hier richtig platziert?})\newline
...
\begin{figure}[h]
  ...
  Für das dritte Netzwerk werdem lediglich die Label des semi-supervised Algorithmus eingesetzt.
  Die letzte Variante wird semi supervised vortrainiert und anschließend mit den Zieldaten finetuned. }
  \label{fig:pretrain}
\end{figure}
