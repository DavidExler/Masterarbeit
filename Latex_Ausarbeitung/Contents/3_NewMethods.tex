...
Hierzu ist ein Klassifikator notwendig, der den Instanzen eine der TODO X Klassen zuweist.
...
Hierzu werden drei Methoden eingeführt und in Experimenten verglichen.
Die erste Methode ist konventionelles Zero-Padding, also das symetrische Hinzufügen von Nullen an die Ränder des Bilds.
Eine weitere Methode ist einfache bilineare oder bikubische Interpolation.
...
\begin{figure}
  \includegraphics[width=\linewidth]{Figures/SWINV2_Architecture.png}
\end{figure}
