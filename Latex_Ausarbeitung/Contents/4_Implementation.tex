...
Um den Klassifikator zu trainieren, wird \ac{gt} zu einigen Zieldaten mithilfe der Labeling App erstellt. 
...
\begin{itemize}
    ...
    \item \textit{Next undefined}: Nächsten Nucleus ohne eingetragene \ac{gt} auswählen.
    ...
    \item \textit{Myo}: "Myotuben-Zellkern"-Klasse als \ac{gt} des ausgewählten Nucleus definieren.
    \item \textit{Debris}: "Überreste"-Klasse als \ac{gt} des ausgewählten Nucleus definieren.
    \item \textit{Other}: "Andere"-Klasse als \ac{gt} des ausgewählten Nucleus definieren.
    \item \textit{Schwann}: "Schwannzellen-Zellkern"-Klasse als \ac{gt} des ausgewählten Nucleus definieren.
...
Da die wichtigste Anforderung der Anwendung die nutzerfreundliche Bedienung ist, sind alle Berechnungen, die während der Nutzung der Labeling App ausgeführt werden, darauf ausgelegt, die Rechenzeit zu minimieren. 
