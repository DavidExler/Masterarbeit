...
Die entstehenden Instanzen werden in einen Instanztrenner gegeben (siehe Kap. \ref{sec:Seg_PostProc}), um den Instanzen einzigartige Labels zu vergeben.\\ [0.5\baselineskip]
...
Von der \ac{gui} gehen Start- und Stop-Signale an die wichtigsten Module aus (Segmentierung, Labeling-App, Visualisierung und Methodenvergleich).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/Screenshot_Segmentierung.png}
...
Deepcell & Deepcell Segmentierung & 125 & SciKit-Image, Numpy, deepcell, deepcell\_toolbox  \\
nnU-Net & nnU-Net Segmentierung & 107 & nnunetv2  \\
CellposeSAM & CellposeSAM Segmentierung & 45 & Numpy, cellpose \\
Nachbearbeitung und Bewertung & Nachbearbeitung der Segmentierungsmasken, greedy-Algorithmus und \ac{ipq}-Berechnung & 600 & Numpy, OpenCV, SciKit-Image, SciPy \\midrule
\textbf{Klassifikation} & & & \\
Retreiver & Dynamisches Laden von Bildausschnitten auf die GPU & 100 & dash, plotly \\
Pseudo-Labler & Semi-supervised-Annotationen erstellen & 215 & SciKit-Image, Numy \\
Visualisierungen & Kontur-Bilder, gradCAM, Scatterplots, etc & 650 & SciKit-Image, Numy, Matplotlib, SciPy, Torch \\
Klassifikator erstellen & Encoder- und Klassifikations-Kopf-Code & 300 & Torch, cellpose  \\
Datensatz & Vorverarbeitungsmethoden, Datensatz erstellen & 200 & Torch, Numpy \\
\midrule
\textbf{3D-Zelldaten-Pipeline} & & & \\
Frontend & \ac{gui} der 3D-Zelldaten-Pipeline, Webserver, Threading & 800 & dash, plotly \\
Websever backend & Unterstützende Funktionen für das Frontend-serving & 100 & - \\
