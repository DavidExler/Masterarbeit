...
Auf der X-Achse sind als Gruppen zuerst die Encoder und zuletzt der Durchschnitt aufgetragen, und auf der Y-Achse die durchschnittliche Genauigkeit der Modelle mit dem jeweiligen Decoder.
An den Daten lässt sich erkennen, dass der Einfluss des Decoders nicht homogen ist.
...
Die Balken rechts, die je den Durchschnitt aller Modelle mit einem Decoder darstellen, zeigen mit einem signifikanten t-Test, dass der Volumen-Klassifikator insgesamt bessere Ergebnisse liefert.
