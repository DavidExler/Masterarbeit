...
Vergleiche der Ergebnisse verschiedener Methoden zeigen, dass die neu eingeführten Methoden wie der Pseudo-Labler (siehe Kap. \ref{sec:Pretrain}) je nach Anforderung dem Stand der Technik entsprechen.
...
Die Konturfarben der Nuclei kennzeichnen ihre Klassen.
...
Wie in Abschnitt \ref{sec:Preproc} beschrieben, wird dieses Problem der ungleichen Verteilung der Klassen mit Hilfe des Retreivers durch eine Gewichtung der Gradienten unterrepräsentierter Klassen angegangen.
