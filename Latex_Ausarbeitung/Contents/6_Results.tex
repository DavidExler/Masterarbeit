...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/Slice_Decoder_1and4.pdf}
...
Rechts ist das \linebreak fully-supervised ImageNet-Vortraining mit eingefrorenen Encoder-Gewichten und kein Vortraining aufgetragen (siehe Kap. \ref{sec:Pretrain}).
...
Im Durchschnitt führt das Fortführen des Trainings mit den annotierten Daten nach dem \linebreak semi-supervised-Training zu einer Steigerung der Genauigkeit um 13 Prozentpunkte.
Für den ConvNeXt-Encoder ist der Vorteil des fortgesetzten Trainings besonders hoch mit 39 Prozentpunkten.
Der ConvNeXt-Encoder ist außerdem mit dem \linebreak semi-supervised-Vortraining um sieben Prozentpunkte genauer als ohne Vortraining.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/Slice_Decoder_Ebenen.pdf}
