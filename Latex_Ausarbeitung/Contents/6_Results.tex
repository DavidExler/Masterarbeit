...
Die \ac{ipq}-Ergebnisse werden hier auch gegliedert in die drei Faktoren der Metrik betrachtet (siehe Kap. \ref{sec:Kriterien}).
...
\begin{figure}
    \centering\includegraphics[width=\linewidth]{Figures/encoder_v_pretrain.pdf}
