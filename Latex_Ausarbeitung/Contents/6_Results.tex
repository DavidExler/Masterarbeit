...
Die in Kapitel \ref{ch:NewMethods} vorgestellten Methoden zur Klassifikation werden anhand eines seperaten Anteil des manuell gelabelten Datensatz getestet.
Die Genauigkeit, also der Prozentuale Anteil richtiger Vorhersagen, wird als Kriterium verwendet.
