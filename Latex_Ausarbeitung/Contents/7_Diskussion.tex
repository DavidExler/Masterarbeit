...
Da die ResNet-Encoder auch die Encoder mit der geringsten Parameteranzahl sind, liegt die Vermutung nahe, dass die gewählten Encoder zu groß sind und schlechte Ergebnisse einem Architektur-bedingten Overfitting geschuldet sind.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{Figures/Nuclei_Overlap.pdf}
